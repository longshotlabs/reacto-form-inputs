...
import getDateFromDateTimeValues from './shared/getDateFromDateTimeValues.js'
import getDateTimeValuesFromDate from './shared/getDateTimeValuesFromDate.js'
import customPropTypes from './shared/propTypes.js'
import { isEmpty, isEqual } from './shared/utils.js'
...
class DateTimeInput extends Component<any, any> {
  [key: string]: any
    ...
    return (
      <div className={className} style={style}>
        <select
          ...
          style={{ ...styles.monthSelect, ...({ monthSelectStyle } as any) }}
          value={monthValue}
        >
...
;(DateTimeInput as any).propTypes = {
...
;(DateTimeInput as any).defaultProps = {
  className: undefined,
